...
export default class News extends Component {
  ...
  async componentDidMount() {
    ...
    const url = `https://mdikesh.com.np/api/?language=${this.props.language}&category=${this.props.category}&apiKey=${this.props.apiKey}&page=${this.state.page}&pageSize=${this.props.pageSize}`;

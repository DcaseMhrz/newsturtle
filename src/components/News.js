...
export default class News extends Component {
  ...
  async componentDidMount() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?language=${this.props.language}&category=${this.props.category}&apiKey=${this.props.apiKey}&page=${this.state.page}&pageSize=${this.props.pageSize}`;
